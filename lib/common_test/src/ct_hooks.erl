...
-callback on_tc_skip(SuiteName, TestName, Reason, CTHState) ->
                        NewCTHState
                        when
                            SuiteName :: atom(),
                            TestName ::
                            ...
                            CTHState :: term(),
                            NewCTHState :: term().
-callback on_tc_fail(SuiteName, TestName, Reason, CTHState) ->
                        NewCTHState
                        when
                            SuiteName :: atom(),
                            TestName ::
...
-callback pre_end_per_suite(SuiteName, EndData, CTHState) -> Result
                               when
                                   ...
                                   Value :: term(),
                                   Reason :: term().
-callback post_end_per_group(SuiteName, GroupName, Config, Return,
                             CTHState) ->
                                Result
                                when
                                    SuiteName :: atom(),
                                    ...
                                    Value :: term(),
                                    Reason :: term().
-callback pre_end_per_group(SuiteName, GroupName, EndData, CTHState) ->
                               Result
                               when
                                   SuiteName :: atom(),
                                   GroupName :: atom(),
                                   ...
                                   Value :: term(),
                                   Reason :: term().
-callback post_end_per_testcase(SuiteName, TestcaseName, Config, Return,
                                CTHState) ->
                                   Result
                                   when
                                       SuiteName :: atom(),
                                       ...
                                       NewCTHState :: term(),
                                       Result ::
                                           {NewReturn, NewCTHState},
                                       Key :: atom(),
                                       Value :: term(),
                                       Reason :: term().
-callback pre_end_per_testcase(SuiteName, TestcaseName, EndData,
                               CTHState) ->
                                  Result
                                  when
                                      SuiteName :: atom(),
                                      ...
                                      Key :: atom(),
                                      Value :: term().
-callback post_init_per_testcase(SuiteName, TestcaseName, Config,
                                 Return, CTHState) ->
                                    Result
                                    when
                                        SuiteName :: atom(),
                                        ...
                                        Value :: term(),
                                        Reason :: term().
-callback pre_init_per_testcase(SuiteName, TestcaseName, InitData,
                                CTHState) ->
                                   Result
                                   when
                                       SuiteName :: atom(),
                                       ...
                                       Value :: term(),
                                       Reason :: term().
-callback post_init_per_group(SuiteName, GroupName, Config, Return,
                              CTHState) ->
                                 Result
                                 when
                                     SuiteName :: atom(),
                                     ...
                                     Value :: term(),
                                     Reason :: term().
-callback pre_init_per_group(SuiteName, GroupName, InitData, CTHState) ->
                                Result
                                when
                                    SuiteName :: atom(),
                                    GroupName :: atom(),
                                    ...
                                    Value :: term(),
                                    Reason :: term().
-callback post_init_per_suite(SuiteName, Config, Return, CTHState) ->
                                 Result
                                 when
                                     SuiteName :: atom(),
                                     Config :: [{Key, Value}],
